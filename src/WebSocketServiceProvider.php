...
class WebSocketServiceProvider extends ServiceProvider
{
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/web-socket.php', 'web-socket');

        // Register the service the package provides.
        $this->app->singleton('web-socket', function ($app) {
    ...
    protected function bootForConsole(): void
    {
        ...
        $this->publishes([
            __DIR__.'/../config/web-socket.php' => config_path('web-socket.php'),
        ], 'web-socket.config');
